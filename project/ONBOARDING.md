...
**Objective:** This document is intended to bring a new developer up to speed on the project, providing guidance for understanding the architecture, workflows, and key artifacts.

**Status:** Live Document

**Instructions:**
Your primary goal is to gain a complete understanding of the project's current state, architecture, and processes. To do this, you must follow the "Onboarding Flow" outlined below, reviewing each document in the specified order. This sequential review is mandatory for efficient context restoration.
...
## Your First Task: Review the Live Project State
...
1.  **`project/PROJECT_REGISTRY.md`**: The master index for all project artifacts. **Read this first!**
1.  **Current State**: This document provides a narrative summary of the most recent activities, known issues, and the immediate next steps.
3.	**Session Log**: Session reporting progress and findings document.
4.  **project/audit/` Directory**: Review the documents in this directory. They contain the detailed findings, plans, and traceability matrices for any ongoing architectural audit.
...
1. Start with the **Onboarding Documents** to understand where the project stands.
